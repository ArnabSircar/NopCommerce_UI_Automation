...
- Name: regression\e2e.spec.js >> End-to-End Tests >> @regression User registration - login - update profile
- Location: tests\regression\e2e.spec.js:92:3
