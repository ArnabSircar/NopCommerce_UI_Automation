...
- Name: performance\performance.spec.js >> Performance Tests >> @performance Measure navigation between pages
- Location: tests\performance\performance.spec.js:69:3
...
Call log:
  - waiting for locator('.category-grid a:has-text("Computers")')
