...
- Name: functional\navigation.spec.js >> Navigation Tests >> @functional Navigate to category via header menu - Electronics
- Location: tests\functional\navigation.spec.js:84:3
...
Call log:
  - waiting for locator('.header-menu > ul > li:nth-child(2)')
