...
- Name: functional\homepage.spec.js >> Homepage Tests >> @functional Newsletter subscription with invalid email
- Location: tests\functional\homepage.spec.js:83:3
...
Call log:
  - waiting for locator('.newsletter-error')
